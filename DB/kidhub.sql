...
CREATE TABLE ParentActivityKid(
	ParentUsername NVARCHAR(30) not null,
	KidUsername NVARCHAR(30) not null,
	ActivityID int not null,
	constraint PK_ParentActivityKid PRIMARY KEY(ParentUsername, KidUsername, ActivityID));
...
ALTER TABLE ParentActivityKid
ADD CONSTRAINT FK_ParentActivityKid_ParentUsername FOREIGN KEY(ParentUsername) REFERENCES PARENTS(Username) ON UPDATE CASCADE ON DELETE RESTRICT;	
ALTER TABLE ParentActivityKid
ADD CONSTRAINT FK_ParentActivityKid_KidUsername FOREIGN KEY(KidUsername) REFERENCES KIDS(Username) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ParentActivityKid
ADD CONSTRAINT FK_ParentActivityKid_ActivityID FOREIGN KEY(ActivityID) REFERENCES ACTIVITIES(ActivityID) ON UPDATE CASCADE ON DELETE RESTRICT;	
...
ALTER TABLE RideKid
ADD CONSTRAINT FK_RideKid_RideID FOREIGN KEY(RideID) REFERENCES RIDES(RideID) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE RideKid
ADD CONSTRAINT FK_RideKid_KidUsername FOREIGN KEY(KidUsername) REFERENCES KIDS(Username) ON UPDATE CASCADE ON DELETE RESTRICT;

...
ADD CONSTRAINT FK_ActivityKid_KidUsername FOREIGN KEY(KidUsername) REFERENCES KIDS(Username) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ActivityKid
ADD CONSTRAINT FK_ActivityKid_ActivityID FOREIGN KEY(ActivityID) REFERENCES ACTIVITIES(ActivityID) ON UPDATE CASCADE ON DELETE RESTRICT;	
